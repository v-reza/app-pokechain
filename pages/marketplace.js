      ...
      */}
      <div className="min-h-full">
        ...
        <div
          ...
          } lg:flex-col lg:fixed lg:inset-y-0 relative duration-300`}
        >
          <img
                  ...
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? "bg-cyan-800 text-white"
                        : "text-cyan-100 hover:text-white hover:bg-cyan-600",
                      "group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md duration-300 space-x-4"
                    )}
                    aria-current={item.current ? "page" : undefined}
                  >
                    <item.icon
                      className="ml-5 flex-shrink-0 h-6 w-6 text-cyan-200"
                      aria-hidden="true"
                    />
                    {largeSidebarOpen && (
        ...
        <div
          ...
          } flex flex-col flex-1 duration-300 bg-transparent border-r border-gray-300`}
        >
          <div className="relative z-10 flex-shrink-0 flex lg:hidden h-16 bg-white border-b border-gray-200 lg:border-none ">
            <button
              type="button"
